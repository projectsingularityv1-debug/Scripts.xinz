-- ==============================================================================
--  Project XINZ X / Singularity - Modern Lucide & FontAwesome Icon Engine (Compkiller 2.6)
...
function IconEngine:GetIcon(name, font_aws)
	if not name or name == "" then
		return ""
	end

	if type(name) == "table" and name.Image then
		return name.Image
	end

	local strName = tostring(name)

	-- Direct asset URLs or Roblox content IDs
	...
	if font_aws then
		return IconEngine.FontAwesome[strName] or IconEngine.FontAwesome[string.lower(strName)] or strName
	end
...
IconEngine.Icons = setmetatable({}, {
	__index = function(_, key)
		local asset = IconEngine:GetIcon(key)
		return {
			Image = asset,
...
IconEngine.Spritesheets = setmetatable({}, {
	__index = function()
		return ""
	end
})
